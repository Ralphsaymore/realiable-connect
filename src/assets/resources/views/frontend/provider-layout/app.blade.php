...
<head>
    ...
    <body>
        ...
        {{-- MAIN NAVIGATION BAR --}}
        @include('frontend.provider-layout.partials.navbar')

        {{-- SLIDER SECTION --}}
        @if(Request::is('/'))
            @include('frontend.provider-layout.partials.slider')
        @endif

        {{-- SEARCH BAR --}}
        @include('frontend.provider-layout.partials.search')
