<footer class="page-footer indigo darken-2">
    <div class="container">
        <div class="row">
            <div class="col m4 s12">
                ...
                @else
                    <p class="grey-text text-lighten-4">Realible Connect is an online hub for the best accommodation services in Zimbabwe.
                    It also features service providers whom you may need to maintain your property</p>
                @endif
            </div>
            <div class="col m6 s12">
                ...
                <ul class="collection border0">
                    ...
                    <li class="collection-item transparent clearfix p-0 border0">
                        <span class="card-image-bg m-r-10" style="background-image:url({{url('storage/property/'.$property->image)}});width:60px;height:45px;float:left;"></span>
            ...
            <div class="col m2 s12">
                ...
                <ul>
                    ...
                    <li class="uppercase {{ Request::is('service-providers*') ? 'underline' : '' }}">
                        <a href="{{ route('service-providers') }}" class="grey-text text-lighten-3">Agents</a>
                    </li>
    ...
    <div class="footer-copyright">
        <div class="container">
            ...
            @else
                © 2020 Reliable Connect || Developers.
            @endif
