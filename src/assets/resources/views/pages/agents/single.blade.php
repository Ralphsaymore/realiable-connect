                ...
                <div class="col s12 m8">
                    ...
                    <div class="card horizontal card-no-shadow m-b-60">
                        <div class="card-image agent-image">
                            <img src="{{url('storage/users/'.$agent->image)}}" alt="{{ $agent->username }}" class="imgresponsive">
                        </div>
                    ...
                    <h5 class="uppercase">Reviews of {{ $agent->name }}</h5>
                    ...
                    @foreach($properties as $property)
                        ...
                        <div class="card horizontal card-no-shadow border1">
                            <div class="card-image horizontal-bg-image">
                                <span class="card-image-bg" style="background-image:url({{url('storage/property/'.$property->image)}});"></span>
                            </div>
                        ...
                        <div>
                            <ul class="collection with-header m-t-0">
                                <li class="collection-header grey lighten-4">
                                    <h5 class="m-0">Contact with {{ $agent->name }}</h5>
                                </li>
